<template>
  <main>
      ...
      <div class="container">
        <div class="row">
          <div class="col-xs-12 text-center">
            <h1 class="sr-only">Gallery Tile</h1>
            <ol class="breadcrumb darklinks">
              <li><a href="./"> Home </a></li>
              <li><a href="/">Gallery</a></li>
              <li class="active"><span>Gallery Tile</span></li>
            </ol>
          </div>
        </div>
      </div>
    ...
    <section
      class="ls page_portfolio section_padding_top_150 columns_padding_0 columns_margin_0 container_padding_0"
    >
        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="filters isotope_filters text-center darklinks">
              ...
              <a href="/" data-filter=".cat3">Category 3</a>
              <a href="/" data-filter=".cat4">Category 4</a>
            </div>
            <div
              class="isotope_container isotope row masonry-layout"
              data-filters=".isotope_filters"
            >
              <div class="isotope-item col-lg-4 col-md-4 col-sm-6 cat3">
                <div
                  class="vertical-item gallery-item content-absolute text-center ds"
                >
              ...
              <div
                class="isotope-item col-lg-4 col-md-4 col-sm-6 cat1 cat3 cat2"
              >
                <div
                  class="vertical-item gallery-item content-absolute text-center ds"
                >
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-12 text-center">
            <a href="/" class="theme_button gradient1 min_width_button margin_0"
              >Load More</a
            >
          </div>
        </div>

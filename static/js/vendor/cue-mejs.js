...
(function (window, $, undefined) {
	...
	const LOGO_ICON = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 40"><path d="M10,40C4.5,40,0,35.5,0,30s4.5-10,10-10s10,4.5,10,10S15.5,40,10,40z M0,0l40,40V20L20,0H0z M80,0H40v14h40V0z M74,40L60,18L46,40H74z"/></svg>';
	...
	$.extend(MediaElementPlayer.prototype, {
		...
		buildcuebackground: function (player, controls, layers, media) {
			const $background = $(player.container).append($('<img />', {
